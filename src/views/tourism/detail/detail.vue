...
export default {
  ...
  created(){
    ...
    Object.prototype.hasOwnProperty.call(this.$route.query,'data') ? this.form ={...JSON.parse(this.$route.query.data) , status: JSON.parse(this.$route.query.data).status == 1 ? true : false} : null
  },
  components:{
